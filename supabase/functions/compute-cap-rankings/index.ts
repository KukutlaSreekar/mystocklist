...
No markdown, no explanation.`;
  ...
  // NIFTY 100 constituents (Large Cap) - sourced from NSE/smart-investing.in as of Mar 2026
  const KNOWN_LARGE = [
    'RELIANCE', 'HDFCBANK', 'BHARTIARTL', 'SBIN', 'ICICIBANK', 'TCS', 'BAJFINANCE', 'LT', 'INFY',
    'HINDUNILVR', 'LICI', 'MARUTI', 'SUNPHARMA', 'M&M', 'AXISBANK', 'KOTAKBANK', 'ITC', 'TITAN',
    'NTPC', 'HCLTECH', 'ULTRACEMCO', 'ONGC', 'BEL', 'ADANIPORTS', 'JSWSTEEL', 'BAJAJFINSV',
    'VEDL', 'POWERGRID', 'BAJAJ-AUTO', 'COALINDIA', 'HAL', 'ADANIPOWER', 'ADANIENT', 'DMART',
    'HINDZINC', 'TATASTEEL', 'NESTLEIND', 'IOC', 'ZOMATO', 'ASIANPAINT', 'HINDALCO', 'EICHERMOT',
    'WIPRO', 'SBILIFE', 'SHRIRAMFIN', 'GRASIM', 'TVSMOTOR', 'INDIGO', 'DIVISLAB', 'BPCL',
    'BANKBARODA', 'JIOFIN', 'VBL', 'PIDILITIND', 'TORNTPHARM', 'HDFCLIFE', 'BRITANNIA', 'DLF',
    'ADANIGREEN', 'CHOLAFIN', 'SOLARINDS', 'PNB', 'PFC', 'CANBK', 'TRENT', 'TECHM', 'IRFC',
    'MOTHERSON', 'TATAMOTORS', 'ABB', 'LTIM', 'JINDALSTEL', 'TATAPOWER', 'ADANIENSOL',
    'BAJAJHLDNG', 'SIEMENS', 'AMBUJACEM', 'GODREJCP', 'CGPOWER', 'APOLLOHOSP', 'TATACONSUM',
    'DRREDDY', 'CIPLA', 'GAIL', 'MAXHEALTH', 'UNITDSPR', 'MAZDOCK', 'BOSCHLTD', 'ICICIGI',
    'ZYDUSLIFE', 'SHREECEM', 'RECLTD', 'LODHA', 'INDHOTEL', 'JSWENERGY', 'HAVELLS', 'BAJAJHFL',
    'NAUKRI',
  ];
  // Known Mid Cap stocks (not in NIFTY 100, but in NIFTY Midcap 150 / rank 101-250)
  const KNOWN_MID = [
    'IDFCFIRSTB', 'GMRAIRPORT', 'PETRONET', 'DABUR', 'AUROPHARMA', 'BIOCON', 'MPHASIS',
    'COFORGE', 'PERSISTENT', 'CUMMINSIND', 'VOLTAS', 'POLYCAB', 'PIIND', 'ASTRAL', 'OBEROIRLTY',
    'PRESTIGE', 'PAGEIND', 'ATUL', 'DEEPAKNTR', 'NAVINFLUOR', 'METROPOLIS', 'FEDERALBNK',
    'MUTHOOTFIN', 'NHPC', 'SJVN', 'CONCOR', 'LUPIN', 'ALKEM', 'LALPATHLAB', 'LICHSGFIN',
    'INDIAMART', 'NIACL', 'SYNGENE', 'FORTIS', 'KPITTECH', 'LTTS', 'CROMPTON', 'BHARATFORG',
    'SUPREMEIND', 'SUNDARMFIN', 'IPCALAB', 'ESCORTS', 'BALKRISIND', 'ABFRL', 'DELHIVERY',
    'HONAUT', 'PHOENIXLTD', 'SUNTV', 'RAMCOCEM', 'INDIACEM', 'KAYNES', 'COCHINSHIP',
  ];
