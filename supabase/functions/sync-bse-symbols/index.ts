...
function getBSEBackupList(): BSEStock[] {
  ...
  const bseStocks = [
    ...
    // Micro-cap and small-cap BSE stocks
    { code: "511447", id: "SYLPH", name: "Sylph Technologies Limited" },
    { code: "500770", id: "TATACHEM", name: "Tata Chemicals Limited" },
    { code: "532544", id: "FLUOROCHEM", name: "Gujarat Fluorochemicals Limited" },
    { code: "539551", id: "INOXWIND", name: "Inox Wind Limited" },
    { code: "532667", id: "SUZLON", name: "Suzlon Energy Limited" },
    { code: "507685", id: "ORIENTELEC", name: "Orient Electric Limited" },
    { code: "532953", id: "VGUARD", name: "V-Guard Industries Limited" },
    { code: "500043", id: "RAJESHEXPO", name: "Rajesh Exports Limited" },
    { code: "538268", id: "WONDERLA", name: "Wonderla Holidays Limited" },
    { code: "532969", id: "CYBERTECH", name: "Cybertech Systems And Software Limited" },
    { code: "532880", id: "KNRCON", name: "KNR Constructions Limited" },
    { code: "543904", id: "INDIGOPNTS", name: "Indigo Paints Limited" },
    { code: "540173", id: "BIKAJI", name: "Bikaji Foods International Limited" },
    { code: "532839", id: "DISHTV", name: "Dish TV India Limited" },
    { code: "500425", id: "GMRAIRPORT", name: "GMR Airports Limited" },
    { code: "505726", id: "SARDAEN", name: "Sarda Energy & Minerals Limited" },
    { code: "523385", id: "SUNDRMFAST", name: "Sundram Fasteners Limited" },
    { code: "500378", id: "JINDALSAW", name: "Jindal Saw Limited" },
    { code: "526612", id: "GPIL", name: "Godawari Power & Ispat Limited" },
    { code: "517385", id: "NESCO", name: "Nesco Limited" },
    { code: "532478", id: "RAJRATAN", name: "Rajratan Global Wire Limited" },
    { code: "539597", id: "SWARAJENG", name: "Swaraj Engines Limited" },
  ];
...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`BSE sync triggered by authenticated user: ${claimsData.claims.sub}`);
